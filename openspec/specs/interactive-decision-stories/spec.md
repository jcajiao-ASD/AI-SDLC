...
El MVP SHALL incluir historias para elegir un LLM por fase del SDLC, elegir un
agente según el perfil del equipo y elegir un framework agéntico según adopción,
control y calidad.

#### Scenario: Acceso a las historias del MVP
- **WHEN** un usuario abre la portada o el catálogo
- **THEN** SHALL encontrar enlaces diferenciados hacia las tres historias insignia
...
Cada historia SHALL enlazar sus conclusiones y datasets con los estudios fuente,
y cada estudio insignia SHALL enlazar la historia que lo interpreta.

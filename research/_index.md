...
- [Configuración empresarial de OpenSpec mediante `openspec/config.yaml`](configuracion-openspec-yaml.md) — campos, precedencia, inyección de contexto y reglas, stores, límites y plantilla recomendada para un Secure SDLC con controles externos (corte: 22 de julio de 2026).

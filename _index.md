...
- [Comparativa de Agentes de IA con Planes Multi-LLM](comparativa_agentes_ia_multi_llm.md) — Copilot CLI vs. Cursor CLI vs. Junie CLI vs. OpenCode (corte: julio 2026).
